...
!function(a, b) {
    function c(a, b) {
        var c = "complete"
          ...
          , m = function(g) {
            (g.type != d || h.readyState == c) && (("load" == g.type ? a : h)[k](l + g.type, m, e),
            !f && (f = !0) && b.call(a, null))
        }
          , n = function() {
            try {
    ...
    function d(a) {
        ...
        var b = document["getElement" + (a[1] ? "#" == a[1] ? "ById" : "sByClassName" : "sByTagName")](a[2])
          , c = [];
        return null !== b && (c = b.length ? b : 0 === b.length ? b : [b]),
        c
    }
    function e(a, b) {
        var c = {};
    ...
    function g(a) {
        ...
        b.fillStyle = d.background,
        b.fillRect(0, 0, l, m),
        b.fillStyle = d.foreground,
        b.font = "bold " + k + "px " + n;
        ...
        return q / l >= .75 && (k = Math.floor(.75 * k * (l / q))),
        b.font = "bold " + k * e + "px " + n,
        b.fillText(p, l / 2, m / 2, l),
    ...
    function h(a, b, c, d) {
        ...
        c.theme = h,
        b.holder_data = c,
        "image" == a ? (b.setAttribute("alt", i ? i : h.text ? h.text + " [" + j + "]" : j),
        (n || !c.auto) && (b.style.width = f.width + "px",
        b.style.height = f.height + "px"),
        n ? b.style.backgroundColor = h.background : (b.setAttribute("src", g({
            ctx: s,
            dimensions: f,
            template: h,
            ratio: t,
        ...
        c.textmode && "exact" == c.textmode && (r.push(b),
        k(b)))) : "background" == a ? n || (b.style.backgroundImage = "url(" + g({
            ctx: s,
            dimensions: f,
            template: h,
            ratio: t,
        ...
        b.style.backgroundSize = f.width + "px " + f.height + "px") : "fluid" == a && (b.setAttribute("alt", i ? i : h.text ? h.text + " [" + j + "]" : j),
        ...
        n ? b.style.backgroundColor = h.background : (r.push(b),
        k(b)))
    }
    function i(a, b) {
        var c = {
        ...
        if (!c.height && !c.width) {
            ...
            return a.setAttribute("data-holder-invisible", !0),
            setTimeout(function() {
                b.call(this, a)
            }, 1),
            null
        }
        return a.removeAttribute("data-holder-invisible"),
        c
    }
    function k(a) {
        var b;
        ...
        for (var c in b)
            if (b.hasOwnProperty(c)) {
                ...
                if (d.holder_data) {
                    ...
                    e.textmode && "exact" == e.textmode && (e.exact_dimensions = f,
    ...
    if (o.getContext)
        ...
        n = !0;
    n || (p = window.devicePixelRatio || 1,
    q = s.webkitBackingStorePixelRatio || s.mozBackingStorePixelRatio || s.msBackingStorePixelRatio || s.oBackingStorePixelRatio || s.backingStorePixelRatio || 1);
    var t = p / q
      , u = {
        domain: "holder.js",
        images: "img",
    ...
    document.getElementsByClassName || (document.getElementsByClassName = function(a) {
        ...
        if (e.evaluate)
            for (c = ".//*[contains(concat(' ', @class, ' '), ' " + a + " ')]",
            b = e.evaluate(c, e, null, 0, null); d = b.iterateNext(); )
                f.push(d);
        else
            for (b = e.getElementsByTagName("*"),
            c = new RegExp("(^|\\s)" + a + "(\\s|$)"),
            d = 0; d < b.length; d++)
    ...
    a.add_theme = function(b, c) {
        return null != b && null != c && (u.themes[b] = c),
        a
    }
    ,
    ...
    a.run = function(b) {
        ...
        var c = e(u, b)
          ...
          , g = []
          , i = [];
        for ("string" == typeof c.images ? g = d(c.images) : window.NodeList && c.images instanceof window.NodeList ? g = c.images : window.Node && c.images instanceof window.Node && (g = [c.images]),
        ...
        j.setAttribute("id", "holderjs-style"),
        j.type = "text/css",
        document.getElementsByTagName("head")[0].appendChild(j)),
        c.nocss || (j.styleSheet ? j.styleSheet.cssText += c.stylesheet : j.appendChild(document.createTextNode(c.stylesheet)));
        ...
        o = 0; n > o; o++) {
            ...
            v = t = p = null;
            try {
                v = f[o].getAttribute("src"),
                attr_datasrc = f[o].getAttribute("data-src")
            } catch (w) {}
            if (null == attr_datasrc && v && v.indexOf(c.domain) >= 0 ? p = v : attr_datasrc && attr_datasrc.indexOf(c.domain) >= 0 && (p = attr_datasrc),
            p) {
    ...
    ,
    c(b, function() {
        window.addEventListener ? (window.addEventListener("resize", k, !1),
        window.addEventListener("orientationchange", k, !1)) : window.attachEvent("onresize", k),
        m || a.run()
    }),
